#Program to read the values of Temp and Hum from the DHT11 sensor 
# and display them on the LCD #Website: www.circuitdigest.com
...
sensor_name = Adafruit_DHT.DHT11 #we are using the DHT11
sensorsensor_pin = 17 #The sensor is connected to GPIO17 on Pi
...
while 1: #Infinite Loop
    humidity, temperature = Adafruit_DHT.read_retry(sensor_name, sensor_pin) #read from sensor and save respective values in temperature and humidity variable
